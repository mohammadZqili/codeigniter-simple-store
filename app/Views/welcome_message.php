...
<header>
	...
	<div class="menu">
		<ul>
            ...
            if (!logged_in()) {
            ?>
			<li class="menu-item hidden"><a href="/admin/login">Admin Login</a></li>
			<li class="menu-item hidden"><a href="/login">Customer Login</a></li>
                <?php
            }
            ?>
            ...
            if (logged_in()) {
                ...
                <li class="menu-item hidden"><a href="/brands" >Brands</a></li>
	...
	<div class="heroe">
		...
		<h1>Welcome to Electric Store </h1>

		<h2>The small shop</h2>
